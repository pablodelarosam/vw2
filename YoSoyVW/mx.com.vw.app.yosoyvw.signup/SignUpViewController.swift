...
class SignUpViewController: UIViewController, UITextFieldDelegate {
    ...
    var sentTo: String?
    var completeaPhoneNumber: String?
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let signUpConfirmationViewController = segue.destination as? ConfirmSignUpViewController {
            ...
            signUpConfirmationViewController.completePhoneNumber = self.phone.text!
           // signUpConfirmationViewController.u
        }
    }
...
//                        self?.user?.getDetails().continueOnSuccessWith(block: { (details) -> Any? in
//                            print(details)
//                        })
